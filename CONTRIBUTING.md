...
repository](https://github.ibm.com/IBMDigital/CallCenterAgent).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBMDigital/CallCenterAgent/issues). Before embarking on
...
issue](https://github.com/IBMDigital/CallCenterAgent/issues) before sending a pull
